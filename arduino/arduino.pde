...
void setup() {
  ...
  s1 = cp5.addSlider2D("left")
         .setPosition(30,40)
         .setSize(100,100)
         .setMinMax(0,-100,600,100)
         .setValue(0,y)
         .disableCrosshair()
         ;
  s2 = cp5.addSlider2D("right")
         .setPosition(130,40)
         .setSize(100,100)
         .setMinMax(0,-100,600,100)
         .setValue(600,y)
...
void draw() {
  ...
  */
  ...
  s1.setValue(s1.getArrayValue()[0], y);
  s2.setValue(s2.getArrayValue()[0], y);
  popMatrix();
}
